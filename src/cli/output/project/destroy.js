...
const Reconcilable = require('../../../core/resources/reconcilable');
const BaseResourceGroup = require('../../../core/resources/base-resource-group');
 ...
 */
function monitorProjectDestroyReconcilables(root) {
...
module.exports = monitorProjectDestroyReconcilables;
