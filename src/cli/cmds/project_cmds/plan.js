...
import { diff, formatConsoleDelta } from '../../../core/lib/json-diff.js';

const require = createRequire(import.meta.url);

const { Command } = require('commander');
const { loadProject } = require('../../project/load');
const { load } = require('../../../core/actors/deserialize/full');
const loadEnvironment = require('../../project/load-environment');
const { getResourceOptions } = require('../../project/template-actor');
const WharfieProject = require('../../../core/resources/wharfie-project');
const WharfieDeployment = require('../../../core/lib/actor/wharfie-deployment');
 ...
 * @param {import('../../../core/lib/json-diff.js').JsonDelta | undefined} delta - The JSON diff delta.
