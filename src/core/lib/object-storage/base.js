 ...
 *
 * This mirrors the public interface of `src/core/lib/s3.js` (optionally plus any
 ...
 * - Adapters should implement the same behavior as `src/core/lib/s3.js` for the
...
/**
 * NOTE: intentionally matches the misspelling in `src/core/lib/s3.js`:
