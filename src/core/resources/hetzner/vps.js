import { HetznerCloud, HetznerError } from '../../lib/hetzner/index.js';
 ...
 * @property {VPSProperties & import('../../actors/typedefs.js').SharedProperties} properties - properties.
...
class HetznerVPS extends BaseResource {
  ...
  async _reconcile() {
    ...
    if (!server) {
      ...
      /** @type {import('../../lib/hetzner/typedefs.js').CreateServerPayload} */
      const payload = {
        name: this.name,
