...
- [Verified durable run-history checkpoint](llm/checkpoints/2026-07-27-v85-verified-run-history.md) — the latest restart point for fail-closed portable snapshots, shared source/packaged run discovery, explicit redaction and non-authority, focused verification, cleanup, and next work.
