...
- [Jest 30 alignment checkpoint](llm/checkpoints/2026-07-27-v87-jest-30-alignment.md) — the latest restart point for the coherent runtime/globals/types toolchain, direct-and-locked regression, bounded install and disk accounting, focused verification, unresolved local exit 134, and V88.
