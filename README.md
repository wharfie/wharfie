...
- [Disposable test-harness checkpoint](llm/checkpoints/2026-07-27-v86-disposable-test-harness.md) — the latest restart point for coverage-free ordinary tests, explicit CI coverage, runner-owned temporary cache/output cleanup, verification, limits, and next work.
