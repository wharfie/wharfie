 ...
 * @static
 * @name and
 * @param {any[]} conditions - An array of conditions that evaluate to true or
 * false.
 * @returns {any} true if all the specified conditions evaluate to true, or returns
 ...
 * @returns {any} true if the two values are equal or false if they aren't
 */
 ...
 * evaluates to false.
 * @returns {any} one value if the specified condition evaluates to true and another
 ...
 * to true or false.
 * @returns {any} true for a condition that evaluates to false or returns false for a
 ...
 * @param {any[]} conditions - An array of conditions that evaluate to true or
 * false.
 * @returns {any} true if any one of the specified conditions evaluate to true, or
 ...
 * @param {any} a - A value of any type that you want to compare.
 * @param {any} b - A value of any type that you want to compare.
 * @returns {any} false if the two values are equal or true if they aren't
 */
