  ...
  it('no-partitions', async () => {
    ...
    expect(events).toMatchInlineSnapshot(`
      [
        ...
        "STABLE - GlueTable:amazon_berkely_objects_raw",
        "STABLE - GlueTable:amazon_berkely_objects",
        "UNPROVISIONED - WharfieResource:migrate_amazon_berkely_objects",
        "UNPROVISIONED - AthenaWorkGroup:wharfie-test-deployment-migrate_amazon_berkely_objects-workgroup",
        "UNPROVISIONED - GlueTable:migrate_amazon_berkely_objects_raw",
        "DRIFTED - GlueTable:migrate_amazon_berkely_objects_raw",
        "UNPROVISIONED - GlueTable:migrate_amazon_berkely_objects",
        "DRIFTED - GlueTable:migrate_amazon_berkely_objects",
        "UNPROVISIONED - WharfieResourceRecord:test-wharfie-resource-migrate_amazon_berkely_objects-resource-record",
        "UNPROVISIONED - LocationRecord:test-wharfie-resource-migrate_amazon_berkely_objects-location-record",
        "RECONCILING - WharfieResource:migrate_amazon_berkely_objects",
        "RECONCILING - AthenaWorkGroup:wharfie-test-deployment-migrate_amazon_berkely_objects-workgroup",
        "RECONCILING - GlueTable:migrate_amazon_berkely_objects_raw",
        "RECONCILING - GlueTable:migrate_amazon_berkely_objects",
        "RECONCILING - WharfieResourceRecord:test-wharfie-resource-migrate_amazon_berkely_objects-resource-record",
        "RECONCILING - LocationRecord:test-wharfie-resource-migrate_amazon_berkely_objects-location-record",
        "DRIFTED - AthenaWorkGroup:wharfie-test-deployment-migrate_amazon_berkely_objects-workgroup",
        "STABLE - LocationRecord:test-wharfie-resource-migrate_amazon_berkely_objects-location-record",
        "STABLE - AthenaWorkGroup:wharfie-test-deployment-migrate_amazon_berkely_objects-workgroup",
        "STABLE - GlueTable:migrate_amazon_berkely_objects_raw",
        "STABLE - GlueTable:migrate_amazon_berkely_objects",
        "STABLE - WharfieResourceRecord:test-wharfie-resource-migrate_amazon_berkely_objects-resource-record",
        "STABLE - WharfieResource:migrate_amazon_berkely_objects",
        "STABLE - AthenaWorkGroup:wharfie-test-deployment-amazon_berkely_objects-workgroup",
        "STABLE - GlueTable:amazon_berkely_objects_raw",
        "STABLE - GlueTable:amazon_berkely_objects",
        "STABLE - WharfieResourceRecord:test-wharfie-resource-amazon_berkely_objects-resource-record",
        ...
        "STABLE - LocationRecord:test-wharfie-resource-migrate_amazon_berkely_objects-location-record",
        "STABLE - WharfieResource:migrate_amazon_berkely_objects",
        "DESTROYING - WharfieResource:migrate_amazon_berkely_objects",
        "DESTROYING - AthenaWorkGroup:wharfie-test-deployment-migrate_amazon_berkely_objects-workgroup",
        "DESTROYING - GlueTable:migrate_amazon_berkely_objects_raw",
        "DESTROYING - GlueTable:migrate_amazon_berkely_objects",
        "DESTROYING - WharfieResourceRecord:test-wharfie-resource-migrate_amazon_berkely_objects-resource-record",
        "DESTROYING - LocationRecord:test-wharfie-resource-migrate_amazon_berkely_objects-location-record",
        "DESTROYED - WharfieResourceRecord:test-wharfie-resource-migrate_amazon_berkely_objects-resource-record",
        "DESTROYED - LocationRecord:test-wharfie-resource-migrate_amazon_berkely_objects-location-record",
        "DESTROYED - AthenaWorkGroup:wharfie-test-deployment-migrate_amazon_berkely_objects-workgroup",
        "DESTROYED - GlueTable:migrate_amazon_berkely_objects_raw",
        "DESTROYED - GlueTable:migrate_amazon_berkely_objects",
        "DESTROYED - WharfieResource:migrate_amazon_berkely_objects",
        "STABLE - WharfieResource:amazon_berkely_objects",
      ]
    `);
