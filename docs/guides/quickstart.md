...
Build an application with `wharfie app package --self-deployable` to run
these AWS and Hetzner deployment commands through its executable. This remains
an experimental operator surface with focused automated evidence.
