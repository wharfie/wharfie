...
| [0011 — Persisted state-machine execution ledger](0011-persisted-state-machine-execution-ledger.md)                                      | Accepted; amended by 0036–0040                       |
...
| [0040 — Provisioned replacement input and replicated execution payloads](0040-provisioned-replacement-input-and-payload-distribution.md) | Accepted; internal input/distribution slice complete |
