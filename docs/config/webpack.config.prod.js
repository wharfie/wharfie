...
const RSSFeedPlugin = require('./rss-feed-plugin');
...
module.exports = {
  ...
  plugins: [
    ...
    new RSSFeedPlugin({
      jsonFilePath: '../src/assets/journal.json',
      outputFilePath: '../build/rss.xml',
      feedOptions: {
        title: 'Wharfie journal',
        description: 'This is a custom RSS feed generated by Webpack',
        id: 'https://wharfie.dev',
        link: 'https://wharfie.dev',
        language: 'en',
        generator: 'Webpack RSS Feed Plugin',
      },
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      templateParameters: {
        PUBLIC_URL: process.env.PUBLIC_URL || 'https://wharfie.dev',
      },
    }),
    ...
    new webpack.DefinePlugin({
      ...
      'process.env.PUBLIC_URL': JSON.stringify(
        process.env.PUBLIC_URL || 'https://wharfie.dev'
      ),
    }),
