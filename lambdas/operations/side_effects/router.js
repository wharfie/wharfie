...
// const WharfieOperationCompleted = require('../../lib/dynamo/');
 ...
 */
async function side_effect_router(event, context, resource, operation, action) {
...
module.exports = side_effect_router;
