      ...
      PolicyDocument: {
        ...
        Statement: [
          ...
          },
          {
            ...
            Resource: [
              wharfie.util.sub(
                'arn:${AWS::Partition}:s3:::utility-${AWS::AccountId}-${AWS::Region}/wharfie*'
              ),
            ],
          },
          {
            ...
            Resource: [
              wharfie.util.sub(
                'arn:${AWS::Partition}:s3:::utility-${AWS::AccountId}-${AWS::Region}'
              ),
            ],
          },
        ],
          ...
          PolicyDocument: {
            Statement: [
              ...
              },
              {
                ...
                Resource: [
                  wharfie.util.sub(
                    'arn:${AWS::Partition}:s3:::utility-${AWS::AccountId}-${AWS::Region}/wharfie-templates/*'
                  ),
                ],
              },
              {
